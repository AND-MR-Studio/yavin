...
public class QwenChatApi implements LlmApi {
     ...
     *                  如果为 `null`，将按默认规则获取（TODO: API 密钥文档）。
    ...
    public Flux<LlmResponse> call(
        ...
        return apiUtil.postJson(Qwen_Chat, qwenChatApi.getUri(), null, request)
                .retrieveSSE(qwenChatApi.getTimeout());
    }
